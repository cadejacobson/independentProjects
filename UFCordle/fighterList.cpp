...
fighter randomFighter()
{
    ...
    fighter McGregor = { "Conor McGregor", "Ireland", Welterweight, 22, 6, "Striker", 74 };
    fighter Khabib = { "Khabib Nurmagomedov", "Russia", Lightweight, 29, 0, "Wrestler", 70 };
    fighter Nate = { "Nate Diaz", "USA", Welterweight, 20, 13, "BJJ", 76 };
    ...
    fighter Bones = { "Jon Jones", "USA", LightHeavyweight, 26, 1, "Striker", 84 };
    fighter Chuck = { "Chuck Liddell", "USA", LightHeavyweight, 21, 8, "Striker", 76 };
